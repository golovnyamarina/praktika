...
class Tour(models.Model):
    ...
    stock = models.PositiveIntegerField(default=0, verbose_name="Количество доступных мест")
    class Meta:
        verbose_name = 'Тур'
...
class Booking(models.Model):
    ...
    price_at_booking = models.DecimalField(max_digits=10, decimal_places=2, editable=False) # Фиксируем цену тут
